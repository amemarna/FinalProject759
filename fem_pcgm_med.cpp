...
{  
  ...
  FILE *fpe = fopen("edofdatam.inp","r");
  FILE *fpc = fopen("coordatam.inp","r");
  FILE *fph = fopen("hooke0.inp","r");
  FILE *fpg = fopen("gamma.inp","r");
  FILE *fpb = fopen("bcdatam.inp","r");
  FILE *fpl = fopen("bcldatam.inp","r");
  ...
  readmatrix_f(fpe,edofs,nels,neldofs+1);
